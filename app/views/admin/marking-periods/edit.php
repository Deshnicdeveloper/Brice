...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold">Edit Marking Period</h2>
    ...
    <form action="<?= url('admin/marking-periods/edit/' . $period['period_id']) ?>" method="POST" 
        ...
        <div class="mb-4">
            ...
            <input type="text" name="academic_year" id="academic_year" required
                   ...
                   value="<?= htmlspecialchars($period['academic_year']) ?>"
        ...
        <div class="mb-4">
            ...
            <select name="term" id="term" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <option value="1" <?= $period['term'] == 1 ? 'selected' : '' ?>>First Term</option>
                <option value="2" <?= $period['term'] == 2 ? 'selected' : '' ?>>Second Term</option>
                <option value="3" <?= $period['term'] == 3 ? 'selected' : '' ?>>Third Term</option>
            </select>
        </div>
        ...
        <div class="mb-4">
            ...
            <select name="sequence" id="sequence" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <option value="1" <?= $period['sequence'] == 1 ? 'selected' : '' ?>>First Sequence</option>
                <option value="2" <?= $period['sequence'] == 2 ? 'selected' : '' ?>>Second Sequence</option>
            </select>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="start_date" id="start_date" required
                   value="<?= htmlspecialchars($period['start_date']) ?>"
                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="end_date" id="end_date" required
                   value="<?= htmlspecialchars($period['end_date']) ?>"
                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
