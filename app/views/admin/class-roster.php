    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-4">
                <form action="<?= url('admin/class-roster') ?>" method="GET" class="flex gap-4 items-center">
                    <select name="class" class="form-select rounded-md border-gray-300 shadow-sm px-4 py-2" onchange="this.form.submit()">
